...
/** Max lot-page fetches per message — opens a lot's page to read its realized
...
export const COMP_GUIDANCE = [
  ...
  "",
  "If a lot's realized price isn't already in the search result, use web_fetch to open that lot's page and read it (this works on Numisbids). Show the price and currency exactly as the page states them (e.g. CHF, EUR, GBP, USD). Always show a price you find — never drop a comp just because its price needed a fetch to read.",
  "",
