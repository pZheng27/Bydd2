 ...
 * for that image. `original[i]` is the pre-enhancement raw path for photos[i],
 * or "" when photos[i] is itself the raw upload. Images are never cropped
